...
const IP_JEEDOM = 'X.Y.Z.J';

// Alarm host or IP
// Hostname ou Ip de l'alarme
const IP_ALARME = 'X.Y.Z.A';
...
const VIRT_ERRORS_NUMBER="#[Alarme][Visonic][nombreErreurs]#";

// Erreur during the scenario execution? 
// Erreur durant l'execution du scenario ?
const VIRT_ERRORS_EXECUTION_SCENARIO="#[Alarme][Visonic][erreurSurDernierAppel]#";

// Battery level
// Niveau de la batterie
const VIRT_BATTERY_LEVEL="#[Alarme][Visonic][batterie]#";

// GSM Level
// Niveau de reception du mobile
const VIRT_GSM_LEVEL="#[Alarme][Visonic][signalGSM]#";

// Alarm is connected or not?
// Alarme connectée ou non ? 
const VIRT_ALARM_CONNECTED="#[Alarme][Visonic][connectee]#";

// AC trouble or not?
// Problème d'alimentation électrique ?
const VIRT_AC_TROUBLE="#[Alarme][Visonic][defautAllimentationSecteur]#";

// Alarm is low battery?
// Battterie faible sur l'alarme ?
const VIRT_LOW_BATTERY="#[Alarme][Visonic][batterieFaible]#";

// Jaming on the alarm?
// Brouillage de l'alarme
const VIRT_JAMING_TROUBLE="#[Alarme][Visonic][brouillage]#";

// Communication problem
// Problème de communication
const VIRT_COMMUNICATION_FAILURE="#[Alarme][Visonic][problemeCommunication]#";

// Array of values for partition armed state
// Tableau de valeures pour l'état armé de la partition
const VIRT_PART_ARMEE__TAB = array("#[Alarme][Visonic][part1Armee]#", "#[Alarme][Visonic][part2Armee]#", "#[Alarme][Visonic][part3Armee]#");

// Array of values for partition alert state
// Tableau de valeures pour l'état alerte de la partition
const VIRT_PART_ALERTE__TAB = array("#[Alarme][Visonic][part1Alerte]#", "#[Alarme][Visonic][part2Alerte]#", "#[Alarme][Visonic][part3Alerte]#");

// Array of values for partition trouble state
// Tableau de valeures pour l'état défaut de la partition
const VIRT_PART_TROUBLE__TAB = array("#[Alarme][Visonic][part1Trouble]#", "#[Alarme][Visonic][part2Trouble]#", "#[Alarme][Visonic][part3Trouble]#");

// Array of values for partition ready state
// Tableau de valeures pour l'état prête de la partition
const VIRT_PART_PRETE__TAB = array("#[Alarme][Visonic][part1Prete]#", "#[Alarme][Visonic][part2Prete]#", "#[Alarme][Visonic][part3Prete]#");

// Array of values for partition fire state
// Tableau de valeures pour l'état alerte incendie de la partition
const VIRT_PART_INCENDIE__TAB = array("#[Alarme][Visonic][part1Incendie]#", "#[Alarme][Visonic][part2Incendie]#", "#[Alarme][Visonic][part3Incendie]#");

// Alarm port - Normaly should not be modified
// Port de l'alarme - Ne devrait pas être nodifé
const PORT_ALARME = '8181';
...
$curl = curl_init();
//$curl = prepareJsonRpcCall($curl, "PmaxService/registerClient");
